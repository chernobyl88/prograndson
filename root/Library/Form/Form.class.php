...
class Form {
	...
	public function createView(){
		...
		$view .= '<div class="col-lg-offset-4 col-md-offset-4 col-sm-offset-4 col-xs-offset-4 col-lg-4 col-md-4 col-sm-4 col-xs-4"><input class="btn btn-primary" type="submit" value="' . SUBMIT_FORM . '"></div>';
