...
alert(image.src);
		...
		createCropControls: function(){
			...
			var cropControlZoomIn =          '<i class="cropControlZoomIn"></i><p class="legend">Zoomer</p>';
			var cropControlZoomOut =         '<i class="cropControlZoomOut"></i><p class="legend">Dezoomer</p>';
			var cropControlZoomMuchOut =     '';
			var cropControlRotateLeft =      '';
	        var cropControlRotateRight =     '';
	        var cropControlCrop =            '<i class="fa fa-check fa-2x"></i><p class="legend">Valider le recadrage</p>';
			var cropControlReset =           '<i class="cropControlReset"></i><p class="legend">Fermer</p>';
			...
			if(that.options.rotateControls){
				cropControlRotateLeft = '<i class="cropControlRotateLeft"></i><p class="legend">Rotation à gauche</p>';
				cropControlRotateRight = '<i class="cropControlRotateRight"></i><p class="legend">Rotation à droite</p>';
			}
	        ...
	        that.cropControlCrop = that.cropControlsCrop.find('.fa-check');
